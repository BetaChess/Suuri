...
TEST(IntSubtraction, IntegersPositivePositive)
{
	...
	// Test of large integers (using string initializer)
	{
		...
		a = su::big_int_t("213744164203001278214900687669469982484517189418340686233600000000");
		b = 1;
		c = a - b;
		
		EXPECT_EQ(c, su::big_int_t("213744164203001278214900687669469982484517189418340686233599999999"));
	}
}
...
TEST(IntSubtraction, IntegersPositiveNegative)
{
	...
	// Test of large integers (using string initializer)
	{
		...
		EXPECT_EQ(c, su::big_int_t("370370367037037036703703703670"));
		...
		EXPECT_EQ(c, su::big_int_t("740740734074074073407407407340"));
